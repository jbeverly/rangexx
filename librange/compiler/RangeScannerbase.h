...
#ifndef rangecompilerRangeScannerBASE_H_INCLUDED
#define rangecompilerRangeScannerBASE_H_INCLUDED
...
private:
    ...
    size_t (RangeScannerBase::*d_get)() = &RangeScannerBase::getInput;
...
public:
//    RangeScannerBase(RangeScannerBase const &other)             = delete;
//    RangeScannerBase &operator=(RangeScannerBase const &rhs)    = delete;
...
protected:
    RangeScannerBase(std::istream &in, std::ostream &out);
    RangeScannerBase(std::string const &infilename, std::string const &outfilename);
...
template <typename ReturnType, typename ArgType>
inline ReturnType constexpr RangeScannerBase::as(ArgType value)
{
    return static_cast<ReturnType>(value);
}

inline bool RangeScannerBase::knownFinalState()
{
    return (d_atBOL && available(d_final.bol.rule)) ||
           available(d_final.std.rule);
}

inline bool constexpr RangeScannerBase::available(size_t value)
{   
    return value != std::numeric_limits<size_t>::max();
}

inline RangeScannerBase::StartCondition__ constexpr RangeScannerBase::SC(int sc)
{
    return as<StartCondition__>(sc);
}

inline int constexpr RangeScannerBase::SC(StartCondition__ sc)
{
    return as<int>(sc);
}

inline std::ostream &RangeScannerBase::out()
{
    return *d_out;
}

inline void RangeScannerBase::push(size_t ch)
{
    d_input.reRead(ch);
}

inline void RangeScannerBase::push(std::string const &str)
{
    d_input.reRead(str, 0);
}

inline void RangeScannerBase::setFilename(std::string const &name)
{
    d_filename = name;
}

inline void RangeScannerBase::setMatched(std::string const &text)
{
    d_matched = text;
}

inline std::string const &RangeScannerBase::matched() const
{
    return d_matched;
}

inline RangeScannerBase::StartCondition__ RangeScannerBase::startCondition() const
{
    return SC(d_startCondition);
}

inline std::string const &RangeScannerBase::filename() const
{
    return d_filename;
}

inline void RangeScannerBase::echo() const
{
    *d_out << d_matched;
}

inline size_t RangeScannerBase::length() const
{
    return d_matched.size();
}

inline void RangeScannerBase::leave(int retValue) const
{
    throw as<Leave__>(retValue);
}

inline size_t RangeScannerBase::lineNr() const
{
    return d_input.lineNr();
}

inline void RangeScannerBase::more()
{
    d_more = true;
}

inline void RangeScannerBase::begin(StartCondition__ startCondition)
{
    // d_state is reset to 0 by reset__()
    d_dfaBase__ = s_dfaBase__[d_startCondition = SC(startCondition)];
}

inline size_t RangeScannerBase::state__() const
{
    return d_state;
}

inline size_t RangeScannerBase::get__()
{
    return (this->*d_get)();
}

inline size_t RangeScannerBase::getInput()
{
    return d_input.get();
}

inline bool RangeScannerBase::return__()
{
    return d_return;
}

inline void RangeScannerBase::noReturn__()
{
    d_return = false;
}
...
#endif //  RangeScannerBASE_H_INCLUDED
