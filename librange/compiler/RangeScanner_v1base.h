// Generated by Flexc++ V2.01.00 on Mon, 12 May 2014 07:42:26 +0400

#ifndef rangecompilerRangeScanner_v1BASE_H_INCLUDED
#define rangecompilerRangeScanner_v1BASE_H_INCLUDED
...
private:
    ...
    size_t (RangeScanner_v1Base::*d_get)() = &RangeScanner_v1Base::getInput;
...
public:
    RangeScanner_v1Base(RangeScanner_v1Base const &other)             = delete;
    RangeScanner_v1Base &operator=(RangeScanner_v1Base const &rhs)    = delete;
...
protected:
    RangeScanner_v1Base(std::istream &in, std::ostream &out);
    RangeScanner_v1Base(std::string const &infilename, std::string const &outfilename);
...
template <typename ReturnType, typename ArgType>
inline ReturnType constexpr RangeScanner_v1Base::as(ArgType value)
{
    return static_cast<ReturnType>(value);
}

inline bool RangeScanner_v1Base::knownFinalState()
{
    return (d_atBOL && available(d_final.bol.rule)) ||
           available(d_final.std.rule);
}

inline bool constexpr RangeScanner_v1Base::available(size_t value)
{   
    return value != std::numeric_limits<size_t>::max();
}

inline RangeScanner_v1Base::StartCondition__ constexpr RangeScanner_v1Base::SC(int sc)
{
    return as<StartCondition__>(sc);
}

inline int constexpr RangeScanner_v1Base::SC(StartCondition__ sc)
{
    return as<int>(sc);
}

inline std::ostream &RangeScanner_v1Base::out()
{
    return *d_out;
}

inline void RangeScanner_v1Base::push(size_t ch)
{
    d_input.reRead(ch);
}

inline void RangeScanner_v1Base::push(std::string const &str)
{
    d_input.reRead(str, 0);
}

inline void RangeScanner_v1Base::setFilename(std::string const &name)
{
    d_filename = name;
}

inline void RangeScanner_v1Base::setMatched(std::string const &text)
{
    d_matched = text;
}

inline std::string const &RangeScanner_v1Base::matched() const
{
    return d_matched;
}

inline RangeScanner_v1Base::StartCondition__ RangeScanner_v1Base::startCondition() const
{
    return SC(d_startCondition);
}

inline std::string const &RangeScanner_v1Base::filename() const
{
    return d_filename;
}

inline void RangeScanner_v1Base::echo() const
{
    *d_out << d_matched;
}

inline size_t RangeScanner_v1Base::length() const
{
    return d_matched.size();
}

inline void RangeScanner_v1Base::leave(int retValue) const
{
    throw as<Leave__>(retValue);
}

inline size_t RangeScanner_v1Base::lineNr() const
{
    return d_input.lineNr();
}

inline void RangeScanner_v1Base::more()
{
    d_more = true;
}

inline void RangeScanner_v1Base::begin(StartCondition__ startCondition)
{
    // d_state is reset to 0 by reset__()
    d_dfaBase__ = s_dfaBase__[d_startCondition = SC(startCondition)];
}

inline size_t RangeScanner_v1Base::state__() const
{
    return d_state;
}

inline size_t RangeScanner_v1Base::get__()
{
    return (this->*d_get)();
}

inline size_t RangeScanner_v1Base::getInput()
{
    return d_input.get();
}

inline bool RangeScanner_v1Base::return__()
{
    return d_return;
}

inline void RangeScanner_v1Base::noReturn__()
{
    d_return = false;
}
...
#endif //  RangeScanner_v1BASE_H_INCLUDED
